  ...
  return (
    <main className="bg-black">
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 z-10 flex justify-center w-full px-4 py-12 md:py-20 bg-transparent max-w-5xl mx-auto">
          <section className="w-full max-w-5xl mx-auto">
            <motion.div
              ...
              animate="show"
            >
              <motion.div className="space-y-6 text-white" variants={textVariants}>
              ...
              <motion.div className="flex flex-col items-center justify-center space-y-6 pt-4" variants={textVariants}>
            ...
            >
              <img src="/logo.png" alt="AILearn Logo" className="w-28 sm:w-32 md:w-40 lg:w-48 object-contain" />
            </motion.div>
          </section>
        </div>
      </div>
