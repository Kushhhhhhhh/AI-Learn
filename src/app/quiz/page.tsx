      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="topic" className="text-sm md:text-lg font-medium text-gray-300 block mb-2">Topic</label>
              <Input
                id="topic"
                type="text"
                value={topic}
            ...
            <div>
              <label htmlFor="difficulty" className="text-sm md:text-lg font-medium text-gray-300 block mb-2">Difficulty</label>
              <Select value={difficulty} onValueChange={setDifficulty}>
                <SelectTrigger id="difficulty" className="w-full bg-gray-700 text-gray-100 border-gray-600 focus:border-blue-400 focus:ring-blue-400">
